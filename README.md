# Master Artificial Intelligence master thesis LateX template
This is the (new) LateX template for your master artificial intelligence MSc thesis. It includes all the files necessary for writing a great thesis and should streamline the process of formatting such that you can focus on what is important, the content. This was forked from the template for the Information Studies and Data Science MSc thesis template.
